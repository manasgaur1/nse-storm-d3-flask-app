 ...
 */
 ...
 // https://github.com/apache/storm/blob/master/examples/storm-starter/src/jvm/storm/starter/WordCountTopology.java
  ...
  public class SplitJsonBolt extends ShellBolt implements IRichBolt {

    public SplitJsonBolt() {
      super("python", "splitjson.py");
    }

    @Override
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
      declarer.declare(new Fields("symbol","totalTradedVolume"));
    }
